						...
						<td style="width: 100%;"></td>
				        	...
				        	<td style="width: 150px;">
								...
								<div id="app">
								  ...
								  <base-input label="SeatingCapacity" type="text" placeholder="Enter SeatingCapacity" v-model="planeToAdd.seatingCapacity"></base-input>
												                  </form>
								                </div>
            ...
            <div style="text-align: center; padding: 20px;">
              ...
              <button @click="handlePermissionDialogClose">OK</button>
					...
					<td class="detail_view_column_2">Seating Capacity</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="SeatingCapacity" type="text" placeholder="Enter SeatingCapacity" v-model="planeDetails.seatingCapacity"></input>
																		</div>
						</td>
														</tr>
